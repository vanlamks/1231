...
export default function KhachHangDashboard() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-100 via-white to-pink-100 p-10">
      <div className="bg-white rounded-3xl shadow-lg p-10 max-w-4xl mx-auto text-center">
        <h1 className="text-4xl font-extrabold text-gray-700 mb-4">🧍 Trang Khách hàng</h1>
        <p className="text-lg text-gray-600 mb-8">
          Xin chào <b>Khách hàng</b> — bạn có thể xem các điểm thu mua, đặt lịch thu gom và theo dõi đơn hàng của mình.
        </p>
        <button
          onClick={() => navigate("/")}
          className="bg-red-500 text-white px-6 py-2 rounded-xl hover:bg-red-600 transition"
